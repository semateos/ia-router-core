(function (Routes, RouteMatch, NotMatchingError) {
     ...
     * @extends InnoAccel.Router.Regex
    ...
    Routes.Segment = function (segment, defaults) {
         ...
         *
         * Throws a {{#crossLink "InnoAccel.Router.NotMatchingError"}}{{/crossLink}} error it segment does not match.
         *
         * @method rawMatch
         * @protected
         * @param {String} url
...
}(InnoAccel.Router, InnoAccel.Router.RouteMatch, InnoAccel.Router.NotMatchingError));
